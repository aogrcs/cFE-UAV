...
void SAMPLE_AppMain( void )
{
    ...
    */
    while (CFE_ES_RunLoop(&RunStatus) == TRUE)
    {
        ...
        status = CFE_SB_RcvMsg(&SampleAppData.SAMPLEMsgPtr, SampleAppData.SAMPLE_CommandPipe, 500);
...
void SAMPLE_AppInit(void)
{
    ...
    **  messages
    */
    CFE_SB_CreatePipe(&SampleAppData.SAMPLE_CommandPipe, SAMPLE_PIPE_DEPTH,"SAMPLE_CMD_PIPE");
    CFE_SB_Subscribe(SAMPLE_APP_CMD_MID, SampleAppData.SAMPLE_CommandPipe);
    CFE_SB_Subscribe(SAMPLE_APP_SEND_HK_MID, SampleAppData.SAMPLE_CommandPipe);
    CFE_SB_InitMsg(&testData, SAMLPE_TO_HELLO_MID, sizeof(Test_t), TRUE);
...
void SAMPLE_ProcessCommandPacket(void)
{
    ...
    MsgId = CFE_SB_GetMsgId(SampleAppData.SAMPLEMsgPtr);
...
void SAMPLE_ProcessGroundCommand(void)
{
    ...
    CommandCode = CFE_SB_GetCmdCode(SampleAppData.SAMPLEMsgPtr);
